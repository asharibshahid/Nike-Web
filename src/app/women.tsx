  ...
  return (
    <div className=" ml-3 max-w-md p-8 bg-gradient-to-r from-red-400 to-yellow-300 hover:to-purple-400 shadow-lg rounded-lg">
      ...
      <div className="relative h-96 w-full"> {/* Set a fixed height for the container */}
        <Image 
          src= {require("./images/nikw1.png")}// Use the correct image path
          alt="Shoe pic"
      ...
      {/* Shoe Details */}
      <h2 className="mt-4 text-3xl font-bold text-gray-800">Nike Metcone 6</h2>
      <h3 className="text-gray-600">Women's Shoes</h3>
      <p className="mt-2 text-xl  text-gray-800 text-center font-normal">$120
      <br />
      Nike Metcon 6: Built for stability and durability, Nike Metcon 6 is the ultimate training shoe, designed to handle intense workouts with ease.
      </p>
