...
const ShoeDisplay: React.FC = () => {
  ...
  return (
    <div className=" ml-3 max-w-md p-8 bg-gradient-to-r from-red-400 to-yellow-300  hover:to-purple-400 mt-32 shadow-lg rounded-lg">
      {/* Shoe Image */}
      <div className="relative h-96 w-full"> {/* Set a fixed height for the container */}
        <Image 
          src= {require("./images/nike2.png")}// Use the correct image path
          alt="Shoe pic"
      ...
      {/* Shoe Details */}
      <h2 className="mt-4 text-3xl font-bold text-gray-800">Nike Air Max</h2>
      <h3 className="text-gray-600">Both</h3>
      <p className="mt-2 text-xl font-normal text-gray-800 text-center">$100
        <br />
        Nike Air Max: Iconic comfort meets style with Nike Air Max. Featuring visible air cushioning for a smooth ride and bold design that turns heads.
      </p>
